...
class TestSection:
    def test_script_info_section(self):
        for o, s in [
            ...
            (
                ScriptInfoSection([("a", "b"), ("c", "d"), ("", "comment")]),
                textwrap.dedent(
                    """\
                [Script Info]
                a: b
    ...
    def test_aegisub_garbage_section(self):
        for o, s in [
            ...
            (
                AegisubGarbageSection([("Scroll Position", "1"), ("Active Line", "2")]),
                textwrap.dedent(
                    """\
                [Aegisub Project Garbage]
                Scroll Position: 1
                ...
                EventsSection(
                    [
                        Event(
                            ...
                            text=r"hey it's me ur local monkey",
                        ),
                        Event(
                            start=timedelta(seconds=5),
                            end=timedelta(seconds=7),
                            text=r"how are you doing today",
                        ),
                        Event(
                            start=timedelta(seconds=7),
                            end=timedelta(seconds=9),
                            text=r"make sure to stay hydrated and get plenty of rest",
                        ),
                    ]
                ),
                textwrap.dedent(
